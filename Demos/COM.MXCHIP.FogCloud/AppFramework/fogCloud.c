...
void cloudServiceStatusChangedHandler(void* context, easycloud_service_status_t serviceStateInfo)
{
  ...
  cloud_if_log("cloudServiceStatusChangedHandler: entry");
...
OSStatus fogCloudInit(mico_Context_t* const inContext)
{
  ...
  cloud_if_log("fogCloudInit: isActivated: %d", easyCloudContext.service_status.isActivated);
  ...
  cloud_if_log("fogCloudInit: deviceId: %s", easyCloudContext.service_status.deviceId);
  ...
  cloud_if_log("fogCloudInit: masterDeviceKey: %s", easyCloudContext.service_status.masterDeviceKey);
  
  strncpy(easyCloudContext.service_status.device_name, 
          DEFAULT_DEVICE_NAME, MAX_SIZE_DEVICE_NAME);
  cloud_if_log("fogCloudInit: device_name: %s", easyCloudContext.service_status.device_name);
  ...
  cloud_if_log("fogCloudInit: FogCloudServiceInit() start");
  err = FogCloudServiceInit(&easyCloudContext);
  cloud_if_log("fogCloudInit: FogCloudServiceInit() finished");
